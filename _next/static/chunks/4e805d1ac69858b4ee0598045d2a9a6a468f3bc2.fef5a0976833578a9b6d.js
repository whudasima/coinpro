;(window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [8],
  {
    '/J+T': function (e, t, r) {
      ...
      var o = function () {
        return window.imToken && window.imToken.agent
      }
      function d(e) {
        var t =
          ...
          s = r('k+uP'),
          a = o(),
          i = { version: '', device_id: '', dapp_distinct_id: '' }
        if (a) {
          var d = a.split(':')
          i = {
            version: d[1],
            device_id: window.imToken.deviceToken,
            dapp_distinct_id: window.imToken.distinctId,
          }
        }
        s.track(e, n(n({}, t), i))
      }
      var c = function (e) {
        var t =
          ...
          i = r.staging
        s() || i()
          ? console.log('sensors log: ', e, t)
          : d(e, n(n({}, t), {}, { is_tokenlon_web: !0 }))
      }
    },
    'k+uP': function (module, exports, __webpack_require__) {
      var e
      ;(e = function () {
        try {
          var sd = { modules: {} },
          ...
          'object' != typeof JSON && (JSON = {}),
            ...
            (_.mediaQueriesSupported = function () {
              return (
                void 0 !== window.matchMedia || void 0 !== window.msMatchMedia
              )
            }),
            ...
            (_.cookie = {
              ...
              set: function (e, t, r, s, a) {
                ...
                if (0 !== r) {
                  ...
                  's' === String(r).slice(-1)
                    ? c.setTime(
                        c.getTime() + 1e3 * Number(String(r).slice(0, -1)),
                      )
              ...
              getCookieName: function (e, t) {
                var r = ''
                if (
                  ((t = t || location.href), !1 === sd.para.cross_subdomain)
                ) {
                  try {
                    r = _.URL(t).hostname
                  } catch (e) {
            ...
            (_.info = {
              initPage: function () {
                ...
                r ||
                  sd.debug.jssdkDebug('url_domain\u5f02\u5e38_' + t + '_' + r),
                  (this.pageProp = {
                    referrer: e,
              ...
              campaignParams: function () {
                ...
                return (
                  ...
                  _.each(e, function (e) {
                    ;(t = _.getQueryParam(location.href, e)).length &&
                      (r[e] = t)
                  }),
                  r
                )
            ...
            (sd.initPara = function (e) {
              ...
              'string' == typeof sd.para.server_url &&
                ...
                'string' == typeof sd.para.web_url &&
                  ...
                  (sd.para.web_url =
                    location.protocol.slice(-1) + sd.para.web_url),
              ...
              'object' == typeof sd.para.source_type &&
                ((sd.para.source_type.utm = _.isArray(sd.para.source_type.utm)
                  ...
                  : i),
                (sd.para.source_type.search = _.isArray(
                  sd.para.source_type.search,
                )
                  ? sd.para.source_type.search.concat(n)
                  : n),
                (sd.para.source_type.social = _.isArray(
                  sd.para.source_type.social,
                )
              ...
              if (_.isObject(sd.para.heatmap)) {
                ;(sd.para.heatmap.clickmap =
                  ...
                  (sd.para.heatmap.loadTimeout =
                    sd.para.heatmap.loadTimeout || 1e3)
          ...
          ;(sd.quick = function () {
              ...
              _.isString(e) && ((e = {})[r] = 1),
                saEvent.check({ propertiesMust: e }) &&
                  ((function (e) {
                    ...
                    ? saEvent.send(
                        { type: 'profile_increment', properties: e },
                        t,
                      )
                    : sd.log(
            ...
            (sd.detectMode = function () {
              var e = {
                  searchKeywordMatch: location.search.match(
                    /sa-request-id=([^&#]+)/,
                  ),
                  ...
                  function r() {
                    ...
                    t.touch_app_bridge || e.push(sd.debug.defineMode('1')),
                      _.isObject(sd.para.app_js_bridge) ||
                        (e.push(sd.debug.defineMode('2')),
                        (t.verify_success = !1)),
                      (_.isObject(sd.para.heatmap) &&
                        'default' == sd.para.heatmap.clickmap) ||
                        e.push(sd.debug.defineMode('3')),
                      'fail' === t.verify_success &&
                        e.push(sd.debug.defineMode('4'))
                          ...
                          ;(s =
                            ...
                            _.loadScript({
                              success: function () {
                                setTimeout(function () {
                                  'undefined' !=
                                    typeof sa_jssdk_app_define_mode &&
                  ...
                  sd.para.is_track_single_page &&
                    _.addSinglePageEvent(function (e) {
                      ...
                      if ('boolean' == typeof sd.para.is_track_single_page) t()
                        ...
                        'function' == typeof sd.para.is_track_single_page
                      ) {
            ...
            (BatchSend.prototype = {
                  ...
                  ? ((t = _.isArray(sd.para.server_url)
                    ...
                    _.ajax({
                      ...
                      data:
                        'data_list=' +
                        encodeURIComponent(
                          _.base64Encode(JSON.stringify(e.vals)),
                        ),
                      credentials: !1,
              ...
              appendPendingItems: function (e) {
                if (!1 !== _.isArray(e)) {
                  this.sendingItemKeys = _.unique(
                    this.sendingItemKeys.concat(e),
                  )
                  try {
          ...
          ;(sd.sendState = sendState),
            ...
            (sendState.prepareServerUrl = function () {
              if (
                ...
                _.isArray(sd.para.server_url) &&
                sd.para.server_url.length
              )
              ...
              _.isObject(e) &&
                ...
                (e.type && 'profile' === e.type.slice(0, 7)) ||
                  ...
                  sd.para.preset_properties.latest_landing_page &&
                    ...
                    (r.properties.$latest_landing_page =
                      '\u53d6\u503c\u5f02\u5e38'),
                  sd.para.preset_properties.latest_wx_ad_click_id &&
          ...
          ;(sd.bridge = {
            ...
            initState: function () {
              function e(e) {
                function t(e) {
                  ...
                  try {
                    ;(t.hostname = _.URL(e).hostname),
                      (t.project =
                        _.URL(e).searchParams.get('project') || 'default')
                  } catch (e) {
                    sd.log(e)
                  }
                  return t
                ...
                if (sd.para.app_js_bridge.white_list.length > 0)
                  for (
                    var a = 0;
                    a < sd.para.app_js_bridge.white_list.length;
                    a++
                  ) {
            ...
            (sd.JSBridge.prototype.init = function () {
              ...
              window.sensorsdata_app_call_js.modules[this.type] ||
                (window.sensorsdata_app_call_js.modules[this.type] = function (
                  t,
                ) {
                  e.app_call_js(t)
                })
                ...
                n = {
                  ...
                  init: function () {
                    ...
                    var t,
                      r,
                      o = {
                        origin: (r = (t = this.sd)._.URL(t.para.server_url))
                          .origin,
                    ...
                    var c = (d = window.decodeURIComponent(d)).match(
                      /\/sd\/(\w+)\/(\w+)$/,
                    )
                    if (!c)
                      return (
              ...
              var e = function (e, t) {
                ...
                p = {
                  ...
                  getRegularPlugins: function () {
                    ...
                    for (
                      var e = [], t = 0, r = navigator.plugins.length;
                      t < r;
                      t++
                    )
                              ...
                              var n =
                                ...
                                (function (n, o) {
                                  ...
                                  return (
                                    ...
                                    (l = e(l, u)),
                                    (
                                      '00000000' + (u[0] >>> 0).toString(16)
                                    ).slice(-8) +
                                      (
                                        '00000000' + (u[1] >>> 0).toString(16)
                                      ).slice(-8) +
                                      (
                                        '00000000' + (l[0] >>> 0).toString(16)
                                      ).slice(-8) +
                                      (
                                        '00000000' + (l[1] >>> 0).toString(16)
                                      ).slice(-8)
                                  )
                                })(p.get().join(''), 31)
                              _.sd.log(
...
//# sourceMappingURL=4e805d1ac69858b4ee0598045d2a9a6a468f3bc2.fef5a0976833578a9b6d.js.map
